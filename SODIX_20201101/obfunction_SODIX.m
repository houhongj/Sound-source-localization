...
function [fun_syms, x, dfun_syms, djm0] = obfunction_SODIX(num_syms, x_t, CSM, mic_positions, frequencies, ...
...
%     %平滑函数2 ---平滑源强度沿发动机轴线的变化
    ...
    fun_syms =  fun+Regularization_factor(1)*size(x_t,1)*G1+Regularization_factor(2)*G2;
    dfun_syms = dfun+Regularization_factor(1)*size(x_t,1)*dG1+Regularization_factor(2)*dG2;
